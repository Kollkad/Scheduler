...
"""
Модуль определения этапов для приказного производства
...
Основные функции:
- assign_order_stages: Определение этапов дел
...
def assign_order_stages(detailed_df: pd.DataFrame) -> pd.DataFrame:
    """
    Определение этапов сопровождения для дел приказного производства.
