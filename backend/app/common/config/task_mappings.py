    ...
    "lawsuit": {
        ...
        "underConsideration": [
            ...
            },
            {
                ...
                "task_text": "Фиксировать реакцию суда(новая дата, 'решение вынесено')",
                "reason_text": "Проверяется интервал между заседанияи. Между Дата предыдущего заседания и Дата ближайшего заседания суда должно быть не более 2 рабочих дней. Задача ставится если интервал превышен или даты отсутствуют",
                "source": "detailed_report"
            },
            {
                "index": 2,
