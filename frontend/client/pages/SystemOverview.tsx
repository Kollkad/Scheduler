        ...
        <div className="space-y-6">
          ...
          <div className="bg-white p-6 rounded-lg border border-gray-200 shadow-sm">
            ...
            <div className="space-y-4">
              ...
              <StageAccordion
                title="2. Этап закрытия дела"
                description="Проверка своевременности закрытия дела"
                checks={[
                  "Срок: 125 календарных дней с даты подачи иска",
                  "Проверка даты закрытия дела или истечения дедлайна"
                ]}
              />

              <StageAccordion
                title="3. Получение исполнительного документа"
                description="Проверка получения и передачи исполнительного листа"
                checks={[
                  "Интеграция с модулем документов",
                  "Поиск исполнительного листа по коду дела и подразделению ПСИП"
                ]}
              />

              <StageAccordion
                title="4. Вынесение решения"
                description="Проверка сроков вынесения, получения и передачи решения суда"
                checks={[
                  "Вынесение решения: 45 календарных дней от даты принятия дела к производству",
                  "Получение решения: 3 календарных дня от даты вынесения",
                  "Передача решения: 1 календарный день от даты вынесения"
                ]}
              />

              <StageAccordion
                title="5. Рассмотрение дела"
                description="Контроль процессуальных сроков судебного рассмотрения"
                checks={[
                  "Назначение следующего заседания: 3 рабочих дня от даты определения суда",
                  "Интервал между заседаниями: не более 2 рабочих дней",
                  "Общий срок рассмотрения: не более 60 календарных дней от даты подачи иска"
                ]}
              />

              <StageAccordion
                title="6. Реакция суда"
                description="Получение определения суда по поданным документам"
                checks={[
                  "Срок: 7 рабочих дней от даты подачи иска",
                  "Проверка наличия определения суда по делу"
                ]}
              />

              <StageAccordion
                title="7. Смена статуса"
                description="Смена первоначального статуса дела"
                checks={[
                  "Срок: 14 календарных дней от даты подачи иска",
                  "Переход на следующий этап судебного процесса"
                ]}
              />
            </div>
          </div>
          ...
          <div className="bg-white p-6 rounded-lg border border-gray-200 shadow-sm">
            ...
            <div className="space-y-4">
              ...
              <StageAccordion
                ...
                description="Проверка своевременности закрытия дела"
                checks={[
                  "Срок: 90 календарных дней с даты подачи заявления",
                  "Проверка даты закрытия дела или истечения дедлайна"
                ]}
              />
              ...
              <StageAccordion
                title="4. Реакция суда"
                description="Получение реакции суда по поданным документам"
                checks={[
                  "Срок: 60 календарных дней от даты подачи заявления",
                  "Проверка выполнения всех условий: вынесение судебного приказа, заполнение дат получения/передачи ИД, статус 'Условно закрыто'"
                ]}
              />

              <StageAccordion
                title="5. Смена статуса"
                description="Смена первоначального статуса дела"
                checks={[
                  "Срок: 14 календарных дней от даты подачи заявления",
                  "Переход на этап 'Ожидание реакции суда'"
                ]}
              />
            </div>
